    ...
    <div class="event__type-list">
      <fieldset class="event__type-group">
        ...
        <div class="event__type-item">
          <input id="event-type--1" class="event__type-input  visually-hidden" type="radio" name="event-type" value="taxi">
          <label class="event__type-label  event__type-label--taxi" for="event-type--1"></label>
        </div>
